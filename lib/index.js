...
function appendToFoods(name, calories){
  ...
  $('#foods-table').prepend('<tr><td class="food-name-cell">' + name + '</td><td>' + calories + '</td><td>' + deleteButton + '</td></tr>')
}
...
function populateExercises(){
 ...
 function appendToExercises(name, calories){
   var deleteButton = '<button class="delete-button">x</button>'
   $('#exercises-table').prepend('<tr><td class="exercise-name-cell">' + name + '</td><td>' + calories + '</td><td>' + deleteButton + '</td></tr>')
 }
